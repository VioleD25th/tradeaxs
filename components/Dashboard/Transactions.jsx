...
const Transactions = () => {
  ...
  return (
    <>
      <div className="grid max-w-4xl grid-cols-2 mb-10 font-medium text-white md:grid-cols-3 drop-shadow-md contrast-150 lg:grid-cols-4 gap-x-2 xs:gap-x-10 gap-y-3 md:gap-3 lg:gap-5 place-items-start justify-content-start">
        <div className="flex items-center justify-start w-full h-full max-w-full px-2 py-3 space-x-3 rounded-md sm:px-5 sm:p-3 bg-[rgba(12,77,174,0.37)]">
          <span>
        ...
        <div className="flex items-center justify-start w-full h-full max-w-full px-2 py-3 space-x-3 rounded-md sm:p-3 bg-[rgba(12,77,174,0.37)]">
          <span>
        ...
        <Link href="/dashboard/transactions" passHref>
          <a className="flex items-center justify-start w-full h-full max-w-full px-2 py-3 space-x-3  rounded-md sm:px-5 sm:p-3 bg-[rgba(12,77,174,0.37)]">
            <span>
